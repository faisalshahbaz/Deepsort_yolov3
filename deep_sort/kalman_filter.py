...
class KalmanFilter(object):
    ...
    def __init__(self):
        ...
        # the model. This is a bit hacky. hacky：粗糙
        self._std_weight_position = 1. / 20  # 卡尔曼滤波中位置变量和速度变量对下一状态估计的贡献量
    ...
    def update(self, mean, covariance, measurement):
        ...
        new_mean = mean + np.dot(innovation, kalman_gain.T)  # dot: 矩阵乘积， .T 转置
